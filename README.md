...
```text
...  taxonomy                   coverage  dispersion  fraction  containment  PTR     log2(PTR)
...  ...Bacillus subtilis       5.9939    0.9057      1.0000    0.9936       1.5451  0.6277
...  ...Klebsiella pneumoniae   12.0417   0.9715      0.9956    0.9867       1.2804  0.3566
...  ...Morganella morganii     9.9278    0.9222      0.9716    0.9766       1.3799  0.4646
...  ...Pseudomonas_E putida_U  5.6176    0.8939      0.9955    0.9859       1.7704  0.8240
```
